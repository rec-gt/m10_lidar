...
class Service:
    ...
    def init_plot(self):
        ...
        if CFG_PLOTTING:
            ...
            self.scatter = self.plot_p.scatterPlot(size=5, pen=pg.mkPen(color='r', width=2), symbol='o')
            scatter_center = self.plot_p.scatterPlot(size=10, pen=pg.mkPen(color='y', width=3), symbol='o')
            scatter_center.setData(x=[0], y=[0])
            scatter_range = self.plot_p.scatterPlot(size=10, pen=pg.mkPen(color='g', width=2), symbol='o')
